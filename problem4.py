...
for img in os.listdir(path):
    ...
    #print(imageName)
    jpgPath = r"C:\Users\hmzsh\Pictures\needsWork\problem4\{}.jpg".format(imageName)
    ...
    if fileExt == ".txt":
        ...
        color = (200, 0, 0) # color of bounding box
