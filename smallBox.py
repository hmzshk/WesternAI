...
for category in classes:
    ...
    for img in os.listdir(path):
        ...
        if fileExt == ".txt":
            ...
            if area < 75000:
                #print("too small {} Area: {} width: {} height: {}".format(img,int(area),int(w),int(h)))
                underSized.append(img)
                pathTosave = r"C:\Users\hmzsh\Pictures\combined\{}\{}.jpg".format(category,imageName)
                cv2.imwrite(pathTosave,image)
                newTxtpath = r"C:\Users\hmzsh\Pictures\combined\{}\{}.txt".format(category,imageName)
...
print(underSized)
print("Number of small bounding boxes: ", len(underSized))
print("done")
