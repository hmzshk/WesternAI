    ...
    def inference(self, image):
        ...
        for output in layerOutputs:
            ...
            for detection in output:
                ...
                scores = detection[5:] # get the first five predictions
                classID = np.argmax(scores) # get the maximum value/highest score
                ...
                if confidence > self.confidence:
                    ...
                    # and class IDs
                    boxes.append([x, y - 50, int(width), int(height) + 50])
