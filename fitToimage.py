...
for img in os.listdir(path):
    ...
    if fileExt == ".txt":
        ...
        newTxtpath = r"C:\Users\hmzsh\Pictures\Train_dir\{}.txt".format(imageName)
        pathTosave = r"C:\Users\hmzsh\Pictures\Train_dir\{}.jpg".format(imageName)
        if A < 1:
            print("Corrected!")
            A = 1
            corrected.append(img)
            print("After " + img + " A: {} B: {} C: {} D: {} num_cols {} num_rows {}".format(int(A),int(B),int(C),int(D),num_cols,num_rows))
